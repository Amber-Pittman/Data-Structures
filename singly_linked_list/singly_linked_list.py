...
print(f'the start of the list is {linked_list.head.value}')
# Add some more to the head and then Print Max
linked_list.add_to_head(13)
linked_list.add_to_head(22)
linked_list.add_to_head(42)
linked_list.add_to_head(19)
print("\nThe Maximum value of a node in the Linked List is:", linked_list.get_max(), "\n")